...
package com.cyuuni.cyuuniutils;
...
public class CyHttp {
    ...
    */
    ...
    public <T> void post( String url, Header[] headers, RequestParams params, String contentType,RequestCallBack<T> callBack) {
    ...
    public void post( String url, Header[] headers, HttpEntity entity, String contentType,RequestCallBack<? extends Object> callBack) {
  ...
  //------------------put 请求-----------------------
    ...
    public void put( String url, HttpEntity entity, String contentType, RequestCallBack<? extends Object> callBack) {
        sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(url), entity), contentType, callBack);
    }
    
    public void put(String url,Header[] headers, HttpEntity entity, String contentType, RequestCallBack<? extends Object> callBack) {
    ...
    public void delete( String url, Header[] headers, RequestCallBack<? extends Object> callBack) {
        final HttpDelete delete = new HttpDelete(url);
    ...
    protected <T> void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, RequestCallBack<T> requestCallBack) {
        if(contentType != null) {
            uriRequest.addHeader("Content-Type", contentType);
        }

        new HttpHandler<T>(client, httpContext, requestCallBack,charset)
